...
| 4 | `04-focused-details-light.png` | `createDemoWorkspaceFixture()` Project A | en-US | Light | Q2 focused, Details open; canvas panned so Q2 is visible | Q2 `open`; sibling Q1 active | Default, then user pan (no `fitView`) |
...
| 7 | `07-dark.png` | `createDemoWorkspaceFixture()` Project A | en-US | Dark | Q2 focused, Details open; canvas panned so Q2 is visible | Same as #4 | Default, then user pan |
| 8 | `08-zh-CN.png` | `createDemoWorkspaceFixture()` Project A | zh-CN | Light | Q2 focused, Details open; canvas panned so Q2 is visible | Same as #4 | Default, then user pan |
