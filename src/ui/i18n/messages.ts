...
const enUS = {
  ...
  "app.themeDark": "Dark",
  "sidebar.title": "Learning projects",
  ...
  "workspace.emptyTitle": "Start a learning project",
  "workspace.emptyBody":
  ...
  "project.emptyTitle": "Start this learning project",
  "project.emptyBody":
...
const zhCN: Record<MessageKey, string> = {
  ...
  "workspace.emptyTitle": "开始一个学习项目",
  "workspace.emptyBody":
    "把一个真正想深入理解的主题，变成可以持续探索和完成的学习树。",
  "workspace.emptyCreate": "创建学习项目",
  "project.emptyTitle": "开始这个学习项目",
  "project.emptyBody":
